import { noop, hooks, Events, EMPTY_OBJ, isNumber, isString, isArray, isUndefined, warn, isFunction, getComponentsAlias as getComponentsAlias$1, internalComponents, toCamelCase, isObject, ensure, isNull, toDashed, controlledComponent } from '../../shared';
...
const isHarmony = "harmony" === 'harmony' || "harmony" === 'harmony';
if (!isWeb && !isHarmony) {
