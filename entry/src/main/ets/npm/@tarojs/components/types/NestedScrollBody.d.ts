 ...
 * @supported weapp
 * @see https://developers.weixin.qq.com/miniprogram/dev/component/nested-scroll-body.html
 */
declare const NestedScrollBody: ComponentType<NestedScrollBodyProps>
export { NestedScrollBody, NestedScrollBodyProps }
