// @ts-nocheck
import { Current, document, requestAnimationFrame, TaroElement, window } from '../../../runtime' // eslint-disable-line import/no-duplicates
import { addLeadingSlash, CONTEXT_ACTIONS, env, eventCenter, TFunc } from '../../../runtime/dist/runtime.esm' // eslint-disable-line import/no-duplicates
import { ensure, hooks, isUndefined } from '../../../shared'
...
import type { AppInstance } from '../../../taro'
